...
function loadChatView() {
  ...
  favoritesRef.on("child_removed", function(favSnapshot) {
    ...
    ////依頼箇所①//// 該当するデータをdbdata.favoritesから削除する
    ///コード記述箇所///
    ...
    ////依頼箇所②//// お気に入りリンクの glyphicon を glyphicon-star-empty に変更する
    ///コード記述箇所///
  ...
  favoritesRef.on("child_added", function(favSnapshot) {
    ...
    addFavoriteMessage(messageId, favorite.message);
     ...
     ////依頼箇所④//// お気に入りリンクの glyphicon を glyphicon-star に変更する
      ///コード記述箇所///
...
function createMessageDiv(messageId, message) {
  ...
  // お気に入りリンクの glyphicon を設定する
  if(dbdata.favorites && dbdata.favorites[messageId]) {
    ////依頼箇所⑤//// お気に入りONのとき（glyphicon-star）
    ///コード記述箇所///
    ...
    ////依頼箇所⑥//// お気に入りOFFのとき（glyphicon-star-empty）
    ///コード記述箇所///
...
function toggleFavorite(event) {
  ...
  if(dbdata.favorites && dbdata.favorites[messageId]) {
    ////依頼箇所⑦//// favorites から該当のお気に入り情報を削除
    ///コード記述箇所///
    ...
    ////依頼箇所⑧//// favorites に該当のメッセージをお気に入りとして追加
    ///コード記述箇所///
